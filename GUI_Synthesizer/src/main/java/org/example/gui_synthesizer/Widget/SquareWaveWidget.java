...
import org.example.gui_synthesizer.Wave.SquareWave;

public class SquareWaveWidget extends AudioComponentWidget {
    protected static int numOfSqWW = 1;
    ...
    protected void setLeft(VBox vbox) {
        ...
        Label title = new Label(name + " #" + numOfSqWW);
        ...
        slider.valueProperty().addListener((obs, oldVal, newVal) -> {
            ...
            ((SquareWave) audioComponent).setFrequency(frequency);
